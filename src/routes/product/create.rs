...
pub async fn create(
    ...
    Json(Body {parent_id, quantity, orig_price, price, produced_date, business_id}): Json<Body>
) -> Response {
    println!("{} {:?} {} {} {} {:?}", parent_id, quantity, orig_price, price, produced_date, business_id);
                ...
                .await.unwrap()
            {
                ...
                None => {
                    let new_product = product::ActiveModel {
                        ...
                        business_id: Set(business_id.unwrap_or(1)),
